...
```{r modify-points-challenge-answer, eval = F}
ggplot(data = complete_old, 
...
```{r modify-color-challenge-answer, warning=FALSE, eval = F}
ggplot(data = complete_old, 
...
<details>
  <summary>Challenge solution</summary>
```{r violin-challenge-answer, warning=FALSE, eval = F}
ggplot(data = complete_old, 
...
```{r violin-challenge-answer-2, warning=FALSE, eval = F}
ggplot(data = complete_old, 
       mapping = aes(x = plot_type, 
                     y = hindfoot_length,
                     color = plot_type)) +
...
```{r customizing-challenge-answer, warning=FALSE, eval = F}
myplot +
  theme_bw() +
